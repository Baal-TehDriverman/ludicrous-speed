...
export const Header: React.FC<HeaderProps> = ({
  ...
  const tabs = [
    { id: 'bug-testing', label: 'Bug Testing & Health', icon: Bug },
    { id: 'local-agents', label: 'Local Agents & Chat', icon: Bot },
    { id: 'all-repos', label: 'Sync & All Repos (41)', icon: FolderGit2 },
    { id: 'gemini37', label: 'Gemini 3.7 Lab', icon: Sparkles },
    { id: 'overview', label: 'Overview', icon: LayoutDashboard },
    { id: 'research', label: 'arXiv & Local Agents', icon: BookOpen },
    { id: 'council', label: '9 Nodes (LilithOS)', icon: Activity },
    ...
    { id: 'repos', label: 'Quick Repos', icon: Database },
    { id: 'telemetry', label: 'Telemetry', icon: Cpu },
    { id: 'void', label: 'Void', icon: Terminal },
  ];
