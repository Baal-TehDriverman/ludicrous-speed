...
import { RepoManagerSection } from './components/RepoManagerSection';
import { NvidiaTelemetrySection } from './components/NvidiaTelemetrySection';
import SephiroticCouncilSection from './components/SephiroticCouncilSection';
import { AllReposManager } from './components/AllReposManager';
import { ArxivResearchSection } from './components/ArxivResearchSection';
import { Gemini37SuperStudio } from './components/Gemini37SuperStudio';
import { LocalAgentsHub } from './components/LocalAgentsHub';
...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<'bug-testing' | 'local-agents' | 'gemini37' | 'overview' | 'research' | 'github' | 'gateway' | 'engine' | 'cyberpunk' | 'dreams' | 'knowledge' | 'repos' | 'telemetry' | 'council' | 'all-repos' | 'void'>('bug-testing');
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-cyan-500 selection:text-slate-950">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="space-y-8">
          ...
          {activeTab === 'telemetry' && (
            <NvidiaTelemetrySection />
          )}

          {activeTab === 'council' && (
            <SephiroticCouncilSection />
          )}
          ...
          {activeTab === 'void' && (
            <VoidSection onRefresh={handleRefreshAll} />
          )}
        </div>
      </main>
