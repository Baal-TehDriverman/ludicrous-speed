...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<'bug-testing' | 'local-agents' | 'gemini37' | 'overview' | 'research' | 'github' | 'gateway' | 'engine' | 'cyberpunk' | 'dreams' | 'knowledge' | 'repos' | 'telemetry' | 'council' | 'all-repos'>('bug-testing');
