  ...
  const stats = [
    {
      ...
      value: `${repos.length || 24} / 41 Mesh`,
      color: 'cyan',
      trend: 'Baal-TehDriverman + Lilith-Systems',
      action: () => onTabChange('all-repos'),
    },
    {
      icon: Server,
      label: 'System Load',
      ...
      <div className="glass rounded-2xl p-6 sm:p-8 border border-slate-800/60">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              onClick={() => onTabChange('all-repos')}
              className="btn-primary flex items-center gap-2"
            >
              <FolderGit2 className="w-4 h-4 text-cyan-300" />
              Sync 41 Repositories
            </button>
            <button
              onClick={() => onTabChange('gemini37')}
