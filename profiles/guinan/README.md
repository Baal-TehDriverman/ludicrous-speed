...
Hermes Agent profile styled after **Guinan** from **Star Trek: The Next Generation**.

## Best at

- Reflective decision coaching
- Narrative and framing analysis
- Mentoring conversations
- Values clarification
- Long-term life or career choices
...
python3 manage.py install guinan --alias
```
